    ...
    const logout={
      ...
      return (
        <Box style={Main}>
          ...
          <>
            <div><p>Please kindly log in or sign up</p>
            ...
            <Box sx={MainRight}>
              <Box sx={{width:screenWidth<=900?"100%":screenWidth<=1200?"700px":"1076px", marginInline:"auto", paddingInline: screenWidth<=1000?"0.7rem":"0"}}>
                <Box sx={feed2}>
                    <Typography sx={{fontSize:screenWidth <= 900  ? "19px" :"22px",fontFamily:"DM SANS", fontWeight:"600" }}>BookMark Post</Typography>
                    <button style={{fontSize:screenWidth <= 900  ? "16px" :"18px", width:screenWidth <= 900  ? "120px" :"170px", cursor:"pointer", padding:screenWidth <= 900  ? "5px" :"8px",fontFamily:"DM SANS"  }}>Write a blog</button>
                </Box>
                <Box sx={Blog}>
                  <BookMark></BookMark>
                </Box>
